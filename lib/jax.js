...
var debug = logger( 'jax' );

var JAX_DOCS_INDEX_URL = 'https://jax.readthedocs.io/en/latest/jax.numpy.html';
var JAX_DOCS_ROOT_URL = 'https://jax.readthedocs.io/en/latest/';


// MAIN //

/**
* Returns a promise for scraping JAX's API documentation for a list of public APIs (e.g., array manipulation methods, etc).
*
* @private
...
async function scrape( options ) {
	...
	debug( 'Navigating to %s.', JAX_DOCS_INDEX_URL );
	await page.goto( JAX_DOCS_INDEX_URL );
