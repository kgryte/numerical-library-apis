...
var debug = logger( 'dask' );

var DASK_DOCS_INDEX_URL = 'https://docs.dask.org/en/latest/array-api.html';
var DASK_DOCS_ROOT_URL = 'https://docs.dask.org/en/latest/array-api.html';


// MAIN //

/**
* Returns a promise for scraping Dask's API documentation for a list of public APIs (e.g., array manipulation methods, etc).
*
* @private
...
async function scrape( options ) {
	...
	debug( 'Navigating to %s.', DASK_DOCS_INDEX_URL );
	await page.goto( DASK_DOCS_INDEX_URL );
