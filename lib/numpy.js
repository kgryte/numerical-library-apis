...
var debug = logger( 'numpy' );

var NUMPY_DOCS_INDEX_URL = 'https://docs.scipy.org/doc/numpy/genindex.html';
var NUMPY_DOCS_ROOT_URL = 'https://docs.scipy.org/doc/numpy/';

var RE_API_INCLUDE = /\(in module numpy.*\)/;
var RE_API_EXCLUDE = /(?:core\.defchararray|ctypeslib|distutils|f2py|lib|testing)/;
...
/**
* Returns a promise for scraping NumPy's API documentation for a list of public APIs (e.g., array creation methods, etc).
*
* @private
...
async function scrape( options ) {
	...
	debug( 'Navigating to %s.', NUMPY_DOCS_INDEX_URL );
	await page.goto( NUMPY_DOCS_INDEX_URL );
